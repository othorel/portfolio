export function ProofSection() {
  return (
    <section className="mx-auto max-w-6xl px-6 pb-24 animate-in fade-in duration-700">
      <div className="grid gap-6 md:grid-cols-3">
        <div className="rounded-2xl border bg-card/50 p-6 transition hover:-translate-y-1 hover:bg-muted/40">
